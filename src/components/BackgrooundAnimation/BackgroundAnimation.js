...
//    <div style={{ width:'100%', height:'100%', top: 0, left: 0, backgroundImage: `url(${background})` }}>
//     {/* <img src="/images/gsrconstruction4.png" alt=""/> */}
//     </div>
// );
    ...
    >
      <g opacity="0.15">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M 50 350 L 100 300 L 150 250 L 200 200 L 250 150 L 300 100 L 500 300"
          stroke="url(#paint0_radial)"
          id="path_0"
        />
        <path
          d="M 50 500 L 100 450 L 150 400 L 200 350 L 250 300 L 350 200 L 500 350"
          stroke="url(#paint1_radial)"
          id="path_1"
        />
        <path
          d="M 200 500 L 250 450 L 300 400 L 350 350 L 400 300 L 450 350 L 500 400"
